        ...
        return (
            <div className='m-5 mt-10'>
                ...
                <div className='flex flex-row'>
                    <a rel="noreferrer" target='_blank' href='https://stats.uptimerobot.com/RKNGPSGkAY' className='text-sm font-semibold text-gray-300 cursor-default'>System State</a>
